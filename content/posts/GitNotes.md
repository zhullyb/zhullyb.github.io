...
title: git笔记
date: 2020-07-11
description: 在这篇关于Git实用技巧的博客中，作者分享了几个提升开发效率的配置方法和常见问题的解决方案。文章详细介绍了如何让Git自动保存账号密码、设置默认的commit编辑器、使用cherry-pick命令连续选取多个提交记录，以及在操作失败时如何撤销。此外，作者还记录了一个实际开发中遇到的推送大仓库失败的问题，通过修改HTTP协议版本成功解决。无论你是Git新手还是有一定经验的开发者，这些技巧都能帮助你更流畅地使用版本控制工具，避免常见陷阱，提高工作效率。
tags: 
      - Linux
      - 笔记 
---
