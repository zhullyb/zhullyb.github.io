...
description: 这篇文章是GNOME开发者写给社区的一封公开信，呼吁停止在默认设置中使用第三方主题来装饰他们的软件。作者们指出，第三方主题不仅破坏了应用原本的设计和用户体验，还可能导致界面混乱、图标含义被曲解、品牌识别度降低等问题。此外，主题化还会使软件截图与用户实际安装后的界面不符，影响用户帮助文档的有效性。虽然开发者理解用户个性化系统的需求，但他们强调，未经测试的主题修改不应由软件开发者承担责任，而应直接反馈给主题作者。这封信旨在维护软件生态的健康，并希望发行版和用户能尊重开发者的设计初衷。
sticky:
tags:
- 翻译
---
