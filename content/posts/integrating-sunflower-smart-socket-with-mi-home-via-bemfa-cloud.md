...
description: 本文详细介绍了如何利用巴法云平台将向日葵智能插座C2接入米家系统，实现通过小爱同学进行远程控制。内容涵盖从巴法云主题创建、MQTT协议选择，到在局域网内使用Armbian设备（如N1盒子）搭建消息转发服务，并提供了完整的Python代码示例，帮助读者一步步完成设备联动。适合IoT爱好者、小米智能家居用户及有一定Python和网络基础的技术爱好者阅读，实现非米家设备与米家生态的无缝集成。
sticky:
tags:
- IoT
- MiAI
