...
date: 2021-05-30
description: 本文详细介绍了在Windows和Linux双系统环境下实现蓝牙鼠标共享的实用方法。通过分析蓝牙配对机制的工作原理，解释了为何双系统切换时需要重复配对的根本原因。文章提供了从Windows系统导出蓝牙密钥、修改Linux系统下蓝牙设备地址、转换并替换密钥参数的具体步骤，包括使用PsTools工具获取注册表信息、十六进制与十进制转换等操作。适合使用双系统且希望提升外设使用效率的用户，尤其对Arch Linux用户有直接参考价值。
tags: 
      - Linux
      - Archlinux
      - Windows
