...
description: 在这篇文章中，我将详细介绍我的博客部署方案，包括如何通过 Hexo 框架、Github Pages 和自购 VPS 实现高效稳定的博客访问体验。我采用了基于 dnspod 的智能 DNS 分流策略，让境内用户访问香港 VPS 以提升速度，境外用户则自动解析至 Github Pages，兼顾访问质量与稳定性。此外，我还分享了如何利用 Github Action 自动化完成博客的生成与部署，解决 Hexo 框架更新繁琐的问题，涵盖环境配置、文件时间修复、时区设置及密钥安全管理等关键步骤。如果你也在寻找低成本、高性能的博客部署方案，这篇文章或许能给你带来一些启发。
sticky:
tags:
- Network
- Github Action
