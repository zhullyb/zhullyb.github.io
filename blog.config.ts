...
const blogConfig: BlogConfig = {
  ...
  footer: {
    social: {
      github: 'https://github.com/zhullyb/',
      mastodon: 'https://zone.liolok.com/@zhullyb',
      email: 'zhullyb@outlook.com'
    },
    poweredBy: {
      name: 'Nuxt',
    ...
    nodeSupport: {
      enabled: true,
      supportId: '61',
      title: 'NodeSupport Project',
      description:
        'Provide free server sponsorship to high-quality blogs, channels, open-source projects, and popular app.',
      primaryBrand: {
        image: 'https://static.031130.xyz/uploads/2025/11/25/2584c5a5ec26b.png',
        href: 'https://yxvm.com/',
        alt: 'yxvm'
      },
      secondaryBrand: {
        image: 'https://static.031130.xyz/uploads/2025/11/25/f56e28d4d53ca.png',
        href: 'https://www.nodeseek.com',
        alt: 'nodeseek'
      },
      githubUrl: 'https://github.com/NodeSeekDev/NodeSupport',
      promotionUrl: 'https://support.nodeget.com/page/promotion?id=61'
    }
  },
  pages: {
    donate: {
      ...
      title: {
        zh: '请我喝点东西',
        en: 'Donate to zhullyb'
      },
      intro: {
        zh: [
          '全天24小时无人值守要饭，要饭我们是专业的。',
          '如果这些内容帮到了你，这里也欢迎随手投喂。'
        ],
        en: [
          'Unattended 7x24 hours ask for begging.',
          'If the blog has been useful to you, a small tip is welcome.'
        ]
      },
      methods: [
        {
          ...
          qrCode: 'https://static.031130.xyz/uploads/2024/08/12/6552d6098f397.webp',
          alt: {
            zh: '微信支付收款码',
        ...
        },
        {
          ...
          qrCode: 'https://static.031130.xyz/uploads/2024/08/12/6552d6098f43c.webp',
          alt: {
            zh: '支付宝收款码',
            en: 'AliPay QR Code'
          }
