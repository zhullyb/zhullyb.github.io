...
我并不知道 tcp 长连接的数据传输应该如何实现，但看起来 MTQQ 是一个比较成熟的协议，因此我选择使用 MTQQ 作为巴法云和 N1 之间的通讯协议。

在巴法云的控制台，选择 MTQQ 设备云，创建一个新的主题，注意需要以 001~009 结尾，否则在米家里看不见创建的这个主题。
...
至此，米家那边的接入已经完成了，我们需要让本地的 N1 盒子使用 MTQQ 协议订阅巴法云的消息。
