...
![](https://npm.elemecdn.com/superbadguy-bed@0.0.5/19.png)
...
![](https://npm.elemecdn.com/superbadguy-bed@0.0.5/20.png)

于是，我们进一步更改deepin-wine-tim的desktop文件，以方便我们不需要每次都在Terminal中执行这么一大长串命令。需要更改的地方如下图红色方框圈出部分

![](https://npm.elemecdn.com/superbadguy-bed@0.0.5/21.png)
