<template>
  <header :class="{ scrolled: isScrolled, 'show-mobile-menu': showMobileMenu }">
    <div class="header-container">
      <div class="header">
        <NuxtLinkLocale :to="'/'" class="header-title">{{ siteTitle }}</NuxtLinkLocale>
        <div class="header-right">
          ...
          <button type="button" class="search-trigger" @click="openSearch" aria-label="Search">
            <IcBaselineSearch />
  ...
  <Banner :background="background" :title="realTitle" :slogan="bannerSlogan" />
...
<script setup lang="ts">
  ...
  const siteTitle = computed(() => appConfig.site.title[localeKey.value])
  const siteSlogan = computed(() => appConfig.site.slogan[localeKey.value])
  ...
  const realTitle = computed(() => props.title || siteTitle.value)
